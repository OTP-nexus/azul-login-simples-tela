            ...
            <div>
              ...
              <p className="text-sm text-green-600 font-normal">
                {generatedFreights.length === 1 
                  ? 'Seu frete completo foi criado e está disponível'
                  : `${generatedFreights.length} fretes completos foram criados para cada destino`
                }
              </p>
            </div>
          </DialogTitle>
        ...
        <div className="space-y-6 py-4">
          ...
          <div className="text-center p-4 bg-green-50 rounded-lg border border-green-200">
            <p className="text-green-800 font-medium">
              {generatedFreights.length === 1 
                ? 'Código de frete gerado:'
                : 'Códigos de frete gerados:'
              }
            </p>
          </div>
          ...
          <div className="p-4 bg-gray-50 rounded-lg">
            ...
            <ul className="text-sm text-gray-600 space-y-1">
              <li>• {generatedFreights.length === 1 ? 'O frete completo está' : 'Os fretes completos estão'} disponível{generatedFreights.length === 1 ? '' : 'eis'} no sistema</li>
