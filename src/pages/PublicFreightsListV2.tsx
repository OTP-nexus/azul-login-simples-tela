...
import { usePublicFreightsV2, PublicFreightFilters } from '@/hooks/usePublicFreightsV2';
...
import PublicFreightsFilterV2 from '@/components/PublicFreightsFilterV2';
...
const PublicFreightsListV2 = () => {
  const [filters, setFilters] = useState<PublicFreightFilters>({});
  const [currentPage, setCurrentPage] = useState(1);
  const { freights, loading, error, pagination } = usePublicFreightsV2(filters, currentPage, 20);
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="text-center py-6">
        <h1 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
          Fretes Disponíveis V2
        </h1>
        <p className="mt-2 text-lg leading-6 text-gray-600">
          Sistema de filtros completamente novo - mais rápido e preciso.
        </p>
      </div>
      ...
      <div className="flex-1 flex flex-col lg:flex-row gap-6 px-4 lg:px-6">
        ...
        <div className="hidden lg:block lg:w-80 xl:w-96 lg:flex-shrink-0">
          <div className="sticky top-6">
            <PublicFreightsFilterV2 onFilterChange={handleFilterChange} initialFilters={filters} />
          </div>
        </div>
...
export default PublicFreightsListV2;
